                ...
                <div class="relative z-10 flex flex-col md:flex-row gap-6 justify-between items-start">
                    ...
                    <div class="flex-1 space-y-3">
                        ...
                        <div class="flex items-center gap-2 pt-2">
                            ...
                            <a href="{{ route('job-applications.resume', $jobApplication->id) }}" target="_blank" class="text-sm text-brand-400 hover:text-brand-300 hover:underline flex items-center gap-1">
